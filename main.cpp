...
int main(int, char**)
{
    ...
    GLFWwindow* window = glfwCreateWindow(1280, 720, "Hidden Apps", NULL, NULL);
    if (window == NULL)
        return 1;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to created a named window.
        {
            ...
            */
            ...
            ImGui::Text("Enter the Process Name or PID");

            ImGui::InputText("", processNameOrPid, sizeof(processNameOrPid));
